...
public class BuildUHCDuelQueue extends DuelQueue {

	public BuildUHCDuelQueue(Server server, boolean ranked) {
		super(server, "BuildUHC", WorldCategory.DUEL_NORMAL, ranked);
	}
	...
	protected void onStart() {
		...
		for (Player enemy : getEnemies()) {
			server.dispatchCommand(enemy, "inventory duel_buhc");
