...
public class SumoDuelQueue extends DuelQueue {

	public SumoDuelQueue(Server server, boolean ranked) {
		super(server, "Sumo", WorldCategory.SUMO, ranked);
	}
	...
	protected void onStart() {
		...
		for (Player enemy : getEnemies()) {
			server.dispatchCommand(enemy, "inventory empty");
